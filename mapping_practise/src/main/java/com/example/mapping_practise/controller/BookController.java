...
import com.example.mapping_practise.service.BookService;
...
public class BookController {
    ...
    @PostMapping("/edit/{id}")
    public ResponseEntity<BookResponseDto> editBook(@PathVariable final Long id,@RequestBody BookRequestDto bookRequestDto){
    ...
    public ResponseEntity<BookResponseDto> addAuthor(@PathVariable final Long authorId,@PathVariable final Long bookId){
        BookResponseDto bookResponseDto= bookService.addUthorToBook(bookId,authorId);
        return new ResponseEntity<>(bookResponseDto,HttpStatus.OK);
